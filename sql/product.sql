...
insert into product (name, brand, category_id, unit_price, material , image) values ('天然橡膠瑜伽墊 | 純淨版(紫色) ','Yottoy', 2(select id from category where name ='瑜伽墊'),'$488','天然橡膠、PU', 'public/image/yoga_mat/yoga_mat_2_purple.webp' );
...
insert into product (name, brand, category_id, unit_price, material , image) values ('瑜伽平衡健身半圓平衡球','MEJEY', (select id from category where name ='瑜伽墊'),'$688','PE環保物料', 'public/image/yoga_ball/yoga_ball_1webp' );

insert into product (name, brand, category_id, unit_price, material , image) values ('防爆瑜伽普拉提球','ALTUS', (select id from category where name ='瑜伽墊'),'$388','PVC', 'public/image/yoga_ball/yoga_ball_2webp' );

insert into product (name, brand, category_id, unit_price, material , image) values ('防爆迷你瑜伽普拉提球','Master of Muscle', (select id from category where name ='瑜伽墊'),'$188','PVC', 'public/image/yoga_ball/yoga_ball_3webp' );
