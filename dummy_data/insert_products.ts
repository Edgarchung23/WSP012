  ...
  const productDetails: insertProductType[] = [
    {
      name: "M2降噪筋膜按摩槍",
      description:
        "加入AI模式及自動模式，10mm按摩深度大肌肉群，輕鬆滲透，包括漸弱、漸強及波浪模式，令便攜式按摩體驗昇華。配合6個不同形狀按摩頭，針對你不同部位的肌肉酸痛問題。底部加入電量顯示屏，更清晰知道電量消耗。全新肌肉槍M2降噪功能升級，令按摩時更寧靜<加入AI模式及自動模式，10mm按摩深度大肌肉群，輕鬆滲透，包括漸弱、漸強及波浪模式，令便攜式按摩體驗昇華。配合6個不同形狀按摩頭，針對你不同部位的肌肉酸痛問題。底部加入電量顯示屏，更清晰知道電量消耗。",
      brand: "Booster",
      material: "矽膠",
    ...
    //<---------------------------------------------------------MASSAGE BALL--------------------------------------------------------->
    {
      name: "電動瑜伽肌肉按摩筋膜球",
      description:
        "輕巧便攜｜輔助按摩｜環保材質｜四檔可換<br>遠離離延遲性肌肉痠痛DOMS症狀，運動後肌肉會產生乳酸，如不注重肌肉放鬆，會出現肌肉酸痛、腰背酸痛現象，長期得不到有效按摩還會形成肌肉塊。",
      brand: "Yottoy",
      material: "矽膠",
    ...
    },
    {
      name: "深層肌肉按摩筋膜球",
      description:
        "痛點按摩｜消除疲勞｜嚴選矽膠｜<br>方便攜帶全方位按摩頸部、背部、腿部、足步等多處按摩放鬆，運動前激活訓練部位，運動後放鬆緊張肌肉。<br> 小巧便攜 隨時隨地舒適放鬆趕走疲勞，喚醒活力，享受舒適不受限制。",
    ...
    },
    {
      name: "深層肌肉按摩球",
      description:
        "痛點按摩｜消除疲勞｜嚴選PVC｜<br>方便攜帶全方位按摩頸部、背部、腿部、足步等多處按摩放鬆，運動前激活訓練部位，運動後放鬆緊張肌肉。",
      brand: "Master of Muscle",
      material: "矽膠",
      category_id: productCategory_Massageball,
      unit_price: 168,
    ...
    },
    {
      name: "電動瑜伽肌肉按摩筋膜花生球",
      description:
        "四檔模式｜高效按摩｜強勁動力｜<br>靜音降噪肌肉按摩塑造身形全自動按摩球，四擋力度可調節。",
      brand: "Yottoy",
      material: "矽膠",
      category_id: productCategory_Massageball,
      unit_price: 388,
    ...
    },
    {
      name: "德國電動深層按摩球",
      description:
        "振動按摩｜2檔調節｜<br>小巧便攜Beurer德國博依電動深層按摩球結合震動力道讓按摩強度更深入<br>體積小巧輕盈便利攜帶，在家或外出按摩，讓您健康隨時隨地帶著走！塑膠面的凹槽與凸點設計為身體提供支撐，並能幫助固定按摩位置不走位，讓按摩更加精準到位。",
      brand: "Beurer",
      material: "矽膠、ABS樹脂",
      category_id: productCategory_Massageball,
      unit_price: 588,
    ...
    //<--------------------------------------------------------YOGA MAT----------------------------------------------------------->
    {
      ...
      description:
        "輔助跳繩 專業保護靜音減震，家用跳繩墊。<br>高配瑜伽緩衝墊解鎖多種使用方法 ：平板支撐模式，緩沖減震瑜伽兩用；加厚跳繩模式，加厚16MM，隔音加倍。",
      brand: "MEJEY",
      material: "環保TPE",
    ...
    },
    {
      name: "天然橡膠瑜伽墊 | 純淨版(紫色)",
      description:
        "三重防滑 全新升級來自材料學科技flexible PU與天然橡膠的匠心融合。<br>PU吸水層：PU表層百萬透氣孔，迅速吸收汗水。氣夾層：NonWoven科技紡布<br>隔離排濕，乾爽如初。橡膠基底層：橡膠防滑，緩衝抓地，解決偏移問題。",
      brand: "Yottoy",
      material: "天然橡膠、PU",
      category_id: productCategory_Yogamat,
      unit_price: 488,
    ...
    },
    {
      name: "天然橡膠瑜伽墊 | 體位線版",
      description:
        "三重防滑 全新升級來自材料學科技flexible PU與天然橡膠的匠心融合。<br>PU吸水層：PU表層百萬透氣孔，迅速吸收汗水。透氣夾層：NonWoven科技紡布<br>隔離排濕，乾爽如初。橡膠基底層：橡膠防滑，緩衝抓地，解決偏移問題。高密度仿生塗層用聚氨酯吸水層，再多的汗也不容易滑倒。",
      brand: "Yottoy",
      material: "天然橡膠、PU",
      category_id: productCategory_Yogamat,
      unit_price: 588,
    ...
    },
    {
      name: "天然橡膠瑜伽墊 | 水波狀紋理版",
      description:
        "5mm純天然橡膠瑜伽墊純天然橡膠材質<br>可自然降解，彷彿置身於大自然的醇香體驗，取於自然，用於自然。<br>中密度5mm厚度非採自亞馬遜熱帶雨林，使用無毒發泡劑，非偶氮染料，乳膠含量≤1%。熱黏合技術採用加熱工藝黏合，不含塑料，通過加熱處理將各層黏合在一起，避免使用有毒膠水。",
      brand: "Manduka",
      material: "純天然橡膠",
      category_id: productCategory_Yogamat,
      unit_price: 1688,
    ...
    },
    {
      name: "天然橡膠瑜伽墊 | 純淨版(綠色",
      description:
        "純天然橡膠製作瑜伽墊採用彩色純天然橡膠新料製作<br>工藝要求高，手感細膩，可以雙面替換使用。<br>雙面防滑設計雙面防滑設計，集環保、不吸油、不吸汗、乾濕防滑、不黏手、彈性及穩定性於一身，手感腳感優良。該墊不建議當高強度健身墊使用，不要穿鞋子或瑜伽襪，或會增加墊子不必要的磨損。",
      brand: "iyogasports",
      material: "彩色純天然橡膠",
      category_id: productCategory_Yogamat,
      unit_price: 1588,
    ...
    //<-----------------------------------YOGA BALL---------------------------------------------->
    {
      name: "瑜伽平衡健身半圓平衡球",
      description:
        "全新一代 免充氣平衡瑜伽半球防滑紋理 <br>穩如泰山旋轉磨砂紋，穩定支撐不打滑，特殊的螺紋紋理，可以有效杜絕運動防滑。",
      brand: "MEJEY",
      material: "PE環保物料",
    ...
    },
    {
      ...
      description:
        "雙層加厚防爆球體表面使用雙層結構<br>所以比一般瑜伽球更厚，兩層各有不同功效，合力保證瑜伽球的安全。<br>內層蜂巢氣囊結構通過高發泡技術，讓球體表面有如密集分佈的蜂巢性氣囊，發生意外穿刺時，球體會緩慢漏氣，確保安全。通過碾壓測試本產品通過專用測試機的150kg滿載防爆測試，450kg滿載瞬間壓力測試。",
      brand: "MEJEY",
      material: "PE環保物料",
      category_id: productCategory_Yogaball,
      unit_price: 788,
    ...
    },
    {
      name: "防爆瑜伽普拉提球",
      description:
        "防爆工藝 避免損傷採用蜂窩為空發泡技術<br>遇刺不爆裂，緩慢出氣。光面PVC 防滑耐磨優質選材，防滑耐磨性全面升級。<br>零壓回彈 貼心呵護球體無壓力記憶回彈，能均勻分散壓力，高彈使身體能被托起，避免關節軟組織受損。",
      brand: "Master of Muscle",
      material: "PVC",
      category_id: productCategory_Yogaball,
      unit_price: 388,
